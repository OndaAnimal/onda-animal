              ...
              <form className="admin-animal-form" onSubmit={saveAnimal}>
                ...
                <div className="admin-form-section">
                  ...
                  <div className="admin-fields-grid">
                    ...
                    <label className="span-2"><span>Resumo do card</span><textarea value={animalForm.summary} onChange={(e) => updateAnimal("summary", e.target.value)} /></label>
                    <label className="span-2"><span>História completa</span><textarea value={animalForm.story} onChange={(e) => updateAnimal("story", e.target.value)} /></label>
                    <label className="span-2"><span>Lar ideal</span><textarea value={animalForm.idealHome} onChange={(e) => updateAnimal("idealHome", e.target.value)} /></label>
